...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <img class="animation__shake" src="https://tse1.mm.bing.net/th?id=OIP.teY_ovLSmamC38Ms-fphPgHaHa&pid=Api&P=0&h=180" alt="AdminLTELogo" height="60" width="60">
  </div> -->
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{url('/home')}}" target="_blank" class="nav-link">Go Web</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              <img src="{{url('/adminfront/dist/img/user1-128x128.jpg')}}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              <img src="{{url('/adminfront/dist/img/user8-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="https://tse1.mm.bing.net/th?id=OIP.teY_ovLSmamC38Ms-fphPgHaHa&pid=Api&P=0&h=180" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">Kanun kendra</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="https://tse2.mm.bing.net/th?id=OIP.9v-YvJNS33f3zy3UQo-zXQHaFj&pid=Api&P=0&h=180" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
            <a href="#" class="d-block">Satyam Kumar Tiwari</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{url('/admin-addclint')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{url('/admin-allclint-profile-view')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{url('/admin-allclint-pashi-table')}}" class="nav-link">

...
<body class="hold-transition login-page" style="background-image: url('https://delhidarshan.com/wp-content/uploads/2019/03/Supreme-Court-Delhi.jpg');  background-size: cover;">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
        ...
        <div class="row">
          <div class="col-8">
            <div class="icheck-primary">
              ...
              <a href="{{url('/mail')}}"> Forget  password </a>
            </div>
          </div>
          <!-- /.col -->
          <div class="col-4">
      ...
      <div class="social-auth-links text-center mt-2 mb-3">
        ...
        <span class="fas fa-house"></span> Go Home Page
        </a>

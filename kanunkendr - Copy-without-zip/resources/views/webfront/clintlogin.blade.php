...
<body class="hold-transition login-page" style="background-image: url('https://akm-img-a-in.tosshub.com/sites/dailyo/fb_feed_images/story_image/201711/sc-supreme-court-fb_111317012619.jpg');">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1"><b>Kanun</b>Kendra</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Login  to start your session</p>

      <form action="{{url('/clint-login-action')}}" method="get">
        @csrf
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="clintid" placeholder="Enter Clint Id " required>
...
<!-- AdminLTE App -->
<script src="{{url('/adminfront/dist/js/adminlte.min.js')}}"></script>
</body>
</html>
